...
{ // Sensor reading and JSON parsing
  scd30.initialize();
  scd30.setAutoSelfCalibration(1);

  StaticJsonDocument<456> doc; // see: https://arduinojson.org/v6/assistant/
  doc["ID"] = DEVICE_ID;
  // batt
...
{ // Payload parsing of MQTT callback
  String msg;
  for (int i = 0; i < len; i++)
  {
